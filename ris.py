...
# ==========================================
# ИГРОВОЙ ЦЕНТР И ОДИНОЧНЫЕ ИГРЫ (ЧАСТЬ 1)
# ==========================================
...
async def games_menu_handler(message: types.Message):
    ...
    text = (
        ...
        "🎪 _Здесь ты можешь играть один или соревноваться в чате!_\n\n"
...
COOKIE_PREDICTIONS = [
    ...
    {"text": "Свиток Бамбука 🎋: Твоя империя растет крепкой и гибкой.", "type": "xp"}
]
